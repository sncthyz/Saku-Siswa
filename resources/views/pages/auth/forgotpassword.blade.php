...
background: linear-gradient(180deg, rgba(1, 126, 206, 1) 0%, rgba(1, 18, 70, 1) 100%); font-family: 'outfit', sans-serif;">
    ...
    <div class="flex min-h-screen  items-center justify-center pt-20 pb-20 ">
        <div class="relative p-5 pt-20 bg-[#02020281] w-120 rounded-2xl text-white">
            ...
            <h1 class=" text-center poopins pt-3 text-4xl">Forgot Password</h1>
            <p class=" text-center text-s text-blue-300 mb-3 w-100 mx-auto mt-3">Masukkan email Anda untuk menerima link
                reset password.</p>
...
@enderror
                    ...
                    <button type="submit" class="bg-blue-800 p-3 mt-5 w-100 text-white font-bold rounded-xl">Kirim
                        Reset Link</button>
                    <div class="text-center mt-5"> <a href="{{ url('/login') }}" class="text-decoration-none ">Kembali
                            Ke Halaman Login</a>
                </form>
            </div>
