...
background: linear-gradient(180deg, rgba(1, 126, 206, 1) 0%, rgba(1, 18, 70, 1) 100%); font-family: 'outfit', sans-serif;">
    ...
    <div class="flex min-h-screen  items-center justify-center pt-20 pb-20 ">
        <div class="relative p-5 pt-20 bg-[#02020281] w-120 min-h-144 rounded-2xl text-white">
            ...
            <h1 class=" text-center poopins text-3xl">Welcome To Saku Siswa</h1>
            <p class=" text-center text-s text-blue-300 mb-3 w-100 mx-auto mt-3">Silakan lakukan pendaftaran melalui
                formulir di bawah ini untuk melanjutkan.</p>
                ...
                <form action="/register" method="POST">
                    ...
                    <div class="mt-5">
                        <input type="text"
                            ...
                            name="name" placeholder="Nama" required autofocus>
                        @error('name')
            ...
            <h1 class="text-center pt-5 font-bold">Already have account? <a href="/login" class="text-blue-600">Sign
                    In</a> </h1>
